...
int main(int argc, char *argv[]){
    ...
    */
...
#ifdef DINGOO_BUILD
	rc_command("bind u +a"); /* X button */
	rc_command("bind i +b"); /* Y button - LSHIFT*/
	...
	rc_command("bind left +left"); /*  */
	rc_command("bind right +right"); /*  */
	rc_command("bind k +a"); /* A button - LEFTCTRL */
	rc_command("bind j +b"); /* B button - LEFTALT */
	rc_command("bind enter +start"); /* START button */
	rc_command("bind space +select"); // SELECT button
#endif /* DINGOO_BUILD */
